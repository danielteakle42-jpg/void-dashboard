...
"[project]/pages/api/get-creator.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    try {
        ...
        /* ===== FETCH DATA ===== */ let creators = [];
        try {
            creators = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getCreators"])();
        } catch (err) {
            console.error('DATA FETCH ERROR:', err);
            creators = [];
        }
        /* ===== SAFETY ===== */ if (!Array.isArray(creators)) {
        ...
        const total = sorted.length;
        /* ===== NORMALIZE ===== */ const safe = sorted.map((c, i)=>{
        ...
        /* 🔥 ALWAYS RETURN JSON (NEVER HTML) */ return res.status(500).json({
            success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pm.bg7._.js.map